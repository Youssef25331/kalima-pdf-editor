...
import os
import math
from pdf_editor import get_base_path
...
class CTkColorPicker(customtkinter.CTkFrame):
    ...
    def __init__(self,
        ...
        self.img1 = Image.open(os.path.join(PATH,'assets', 'color_wheel.png')).resize((self.image_dimension, self.image_dimension), Image.Resampling.LANCZOS)
        self.img2 = Image.open(os.path.join(PATH, 'assets','target.png')).resize((self.target_dimension, self.target_dimension), Image.Resampling.LANCZOS)
